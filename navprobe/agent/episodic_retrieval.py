...
from navprobe.agent.vln_landmark_context import _landmark_labels_by_id
from navprobe.agent.vln_landmark_context import _global_landmark_index
...
from navprobe.visualization.action_mode_overlays import render_task_progress_bev_overlay_result
from navprobe.visualization.action_mode_overlays import _node_labels_by_id
...
def _landmark_candidates(state: "NavProbeAgentState") -> list[dict[str, object]]:
