...
from navprobe.agent.vln_runtime import begin_vln_step, refresh_vln_state, robot_action_count
...
from navprobe.perception.landmark_buffer import LANDMARK_BUFFER_MERGE_DISTANCE_M
...
from navprobe.runtime.panorama_config import PanoramaConfig, robot_panorama_config
from navprobe.runtime.run_trace import RunTrace
...
def _landmark_categories(client: LLMClient, instruction: str) -> list[str]:
    response = client._create_visual_json_completion(
        ...
        system_prompt=(
            "You are the VLN Landmark Category Generator in NavProbe.\n"
