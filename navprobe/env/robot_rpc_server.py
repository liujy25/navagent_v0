...
from navprobe.env.depth_filter import filter_depth_edges
...
from navprobe.env.rpc_protocol import encode_array
from navprobe.env.rpc_protocol import encode_depth_meters
from navprobe.env.rpc_protocol import encode_rgb_image
...
class ObservationNode(Node):
    def __init__(self) -> None:
        super().__init__("navprobe_observation_node")
...
class NavigationNode(Node):
    def __init__(self) -> None:
        super().__init__("navprobe_navigation_node")
...
class RobotRPCController:
    def __init__(
        ...
        self.observation_runner = NodeRunner(self.observation_node, thread_name="navprobe_observation_spin")
        self.navigation_runner = NodeRunner(self.navigation_node, thread_name="navprobe_navigation_spin")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Robot RPC server for navprobe agent.")
